...
class Interface(Gtk.Window):
    ...
    def on_click_run_button(self, widget):
        ...
        command = "./darknet detector test cfg/voc.data cfg/yolov3.cfg yolov3.weights " + self.choosenimage
        # command="./darknet detector demo cfg/voc.data cfg/yolov3.cfg yolov3.weights "+self.choosenmovie
